...
const I18N = {
  kk: {
    ...
    founder_lead: "Avenue Fashion Boutique-тің жан-жақты иесі әрі негізін қалаушысы. 15 жылдан астам сізбен бірге.",
    founder_body: "Дүкенге 15 жылдан асты — бұл ұзақ, күрделі, бірақ керемет қызықты жол болды. Бүгінде Avenue — көпшіліктің сүйікті бутигі, мұнда тек киіну үшін ғана емес, әңгімелесу, жаңалықтарды білу және бірден дайын капсула жинау үшін келеді. Галинаның стилист ретіндегі талғамы керемет — ол дәл сіздің сұлулығыңызды айқындайтын бейне жасауға көмектеседі.",
  ...
  ru: {
    ...
    founder_title: "Галина",
    founder_lead: "Вдохновительница и создательница Avenue Fashion Boutique. Более 15 лет с вами.",
    founder_body: "Магазину более 15 лет — это был долгий, сложный, но невероятно интересный путь. Сегодня Avenue — любимый многими бутик, куда приходят не только одеться, но и пообщаться, узнать о новинках и сразу собрать готовую капсулу. У Галины потрясающий вкус стилиста — она поможет создать образ, который подчеркнёт именно вашу красоту.",
  ...
  en: {
    ...
    founder_lead: "The inspiration and founder of Avenue Fashion Boutique. With you for over 15 years.",
    founder_body: "The boutique is over 15 years old — a long, challenging, yet fascinating journey. Today Avenue is a beloved boutique where people come not only to dress, but to chat, discover new arrivals and put together a complete capsule on the spot. Galina has an outstanding stylist's eye — she'll help create a look that highlights your unique beauty.",
