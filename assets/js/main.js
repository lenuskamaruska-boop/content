...
const I18N = {
  kk: {
    ...
    store_caption: "Біздің бутик · Ақтау, Green plaza ТК", cat_all: "Барлығы", cat_dresses: "Көйлектер", cat_suits: "Костюмдер", cat_bags: "Сөмкелер", cat_accessories: "Аксессуарлар", cat_empty: "Жақында жаңа түсімдер",
  ...
  ru: {
    ...
    store_caption: "Наш бутик · Актау, ЖК Green plaza", cat_all: "Все", cat_dresses: "Платья", cat_suits: "Костюмы", cat_bags: "Сумки", cat_accessories: "Аксессуары", cat_empty: "Скоро новые поступления",
  ...
  en: {
    ...
    store_caption: "Our boutique · Aktau, Green plaza", cat_all: "All", cat_dresses: "Dresses", cat_suits: "Suits", cat_bags: "Bags", cat_accessories: "Accessories", cat_empty: "Coming soon",
